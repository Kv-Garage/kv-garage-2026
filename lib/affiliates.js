...
// Safe bcrypt import to prevent build failures
let bcrypt;
try {
  bcrypt = require("bcryptjs");
} catch (err) {
  console.error("bcryptjs not installed - affiliate auth will not work");
  bcrypt = null;
}
...
export async function submitAffiliateApplication(data) {
  try {
    // Use supabaseAdmin to bypass RLS for public submissions
