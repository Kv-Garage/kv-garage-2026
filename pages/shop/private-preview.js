...
export default function PrivatePreview() {
  ...
  return (
    <>
      <Head>
        <title>Private Sourcing Desk | Product Inquiry — KV Garage</title>
        <meta
          name="description"
          content="Request products you need. Our private sourcing desk will find verified suppliers and respond within 30 minutes during business hours."
        />
        <meta name="keywords" content="product sourcing, inventory sourcing, wholesale sourcing, custom orders, product inquiry" />
        <link rel="canonical" href={buildCanonicalUrl("/shop/private-preview")} />
        <meta property="og:title" content="Private Sourcing Desk | Product Inquiry — KV Garage" />
        <meta property="og:description" content="Request any product. We source it. Under 30-minute response times." />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
      </Head>

      <main className="min-h-screen bg-gradient-to-br from-[#0B0F19] via-[#111827] to-[#0B0F19] text-white">
        {/* 🔥 PRIVATE PREVIEW HEADER BANNER */}
        <div className="bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 text-white py-3 px-6">
          <div className="max-w-6xl mx-auto flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <span className="text-sm">Product Sourcing Desk - For Items We Don't Stock</span>
            </div>
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-12">
              <div className="flex items-center justify-center gap-4 mb-6">
                ...
                <span className="text-gray-400 text-sm">SOURCING DESK</span>
              </div>
              ...
              <h1 className="text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                ...
                <br />
                <span className="text-gray-300">Request Desk</span>
              </h1>

              <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-4xl mx-auto">
                Don't see what you're looking for? Submit a product request and our procurement 
                team will source directly from verified global suppliers. We handle the sourcing, 
                quality checks, and logistics so you don't have to.
              </p>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-16">
              <div className="bg-gradient-to-br from-blue-900/20 to-transparent border border-blue-500/30 p-8 rounded-2xl text-center">
                ...
                <div className="text-sm text-gray-400">All requests answered within 30 minutes during business hours</div>
              </div>
              ...
              <div className="bg-gradient-to-br from-green-900/20 to-transparent border border-green-500/30 p-8 rounded-2xl text-center">
                ...
                <div className="text-sm text-gray-400">EST Monday through Friday with dedicated sourcing specialists</div>
              </div>
            ...
            <div className="bg-gradient-to-br from-white/5 to-transparent border border-white/20 rounded-3xl p-8 backdrop-blur-sm">
                ...
                <div className="space-y-6">
                  <div className="bg-blue-900/20 border border-blue-500/30 p-6 rounded-xl">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <span className="text-blue-400 font-semibold">PRODUCT SOURCING REQUEST</span>
                    </div>
                    <p className="text-gray-300 text-sm">
                      Tell us what product you need. Include links to product listings, specifications, 
                      or any details that will help us source the exact item you're looking for.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      name="productLink"
                      placeholder="Amazon, Alibaba, Supplier URL, or product listing..."
                  ...
                  <div>
                    ...
                    <textarea
                      name="description"
                      placeholder="Describe the product, specifications, materials, dimensions, color, quantity needed, or any special requirements..."
                      rows="5"
                ...
                <div className="space-y-6">
                  <div className="bg-gradient-to-r from-yellow-900/20 to-transparent border border-yellow-500/30 p-6 rounded-xl">
                    ...
                    <p className="text-gray-300 text-sm">
                      ...
                      your business requirements, budget, and timeline.
                    </p>
                  </div>
                  ...
                  <div className="bg-blue-900/20 border border-blue-500/30 p-6 rounded-xl">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="w-3 h-3 bg-blue-400 rounded-full animate-pulse"></div>
                      <span className="text-blue-400 font-semibold">WHAT HAPPENS NEXT</span>
                    </div>
                    <ul className="text-gray-300 text-sm space-y-2">
                      <li className="flex items-center gap-2">
                        <span className="text-[#D4AF37]">✓</span>
                        Our team reviews your request within 30 minutes
                      </li>
                      <li className="flex items-center gap-2">
                        <span className="text-[#D4AF37]">✓</span>
                        We contact verified suppliers for quotes
                      </li>
                      <li className="flex items-center gap-2">
                        <span className="text-[#D4AF37]">✓</span>
                        You receive multiple sourcing options with pricing
                      </li>
                      <li className="flex items-center gap-2">
                        <span className="text-[#D4AF37]">✓</span>
                        We handle quality checks and logistics
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              {step === 3 && (
                <div className="text-center py-12">
                  ...
                  <h3 className="text-2xl font-bold mb-4">Sourcing Request Submitted</h3>
                  <p className="text-gray-300 mb-8 text-lg">
                    Thank you for your product sourcing request. Our procurement team will review 
                    your requirements and contact you within 30 minutes during business hours with 
                    supplier options and quotes.
                  </p>
            ...
            <div className="mt-16 bg-gradient-to-br from-white/5 to-transparent border border-white/20 rounded-2xl p-8">
              <h3 className="text-2xl font-bold mb-4">Why Use Our Sourcing Desk?</h3>
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h4 className="font-semibold text-[#D4AF37] mb-3">Don't See What You Need?</h4>
                  <p className="text-gray-300 text-sm">
                    Our shop inventory is just the beginning. If you need products we don't currently 
                    stock, our sourcing desk connects you directly to our global supplier network.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-[#D4AF37] mb-3">Verified Suppliers Only</h4>
                  <p className="text-gray-300 text-sm">
                    All suppliers in our network are thoroughly vetted for quality, reliability, 
                    and compliance. We handle the due diligence so you get verified sources.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-[#D4AF37] mb-3">30-Minute Response</h4>
                  <p className="text-gray-300 text-sm">
                    Submit your request and hear back within 30 minutes during business hours. 
                    No waiting days for quotes. Fast, efficient, professional.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-[#D4AF37] mb-3">End-to-End Service</h4>
                  <p className="text-gray-300 text-sm">
                    From initial quote to final delivery, we manage the entire sourcing process 
                    including quality checks, logistics, and customs clearance.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-12 text-center">
              <div className="bg-gradient-to-br from-white/5 to-transparent border border-white/20 rounded-2xl p-8">
                <h3 className="text-2xl font-bold mb-4">Need Products We Don't Stock?</h3>
                <p className="text-gray-300 mb-6 text-lg max-w-2xl mx-auto">
                  Our private sourcing desk is here to find exactly what you need. 
                  Submit your request and let our team do the heavy lifting.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link href="/wholesale">
                ...
                <div className="mt-6 text-sm text-gray-400">
                  Email: <span className="text-white">kvgarage@kvgarage.com</span>
                </div>
              </div>
            </div>
          </div>
