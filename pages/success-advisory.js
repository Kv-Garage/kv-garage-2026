...
export default function SuccessAdvisory() {
  ...
  return (
    <>
      <Head>
        <title>Advisory Access - KV Garage</title>
        <meta name="description" content="Schedule your strategy session for the full advisory program." />
      </Head>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-blue-900/40 backdrop-blur-md rounded-2xl p-6 md:p-10 shadow-xl border border-emerald-500/20">
              ...
              <div 
                ...
                data-url="https://calendly.com/kv-garage/advisory-strategy"
            ...
            <div className="mt-12 text-center">
              <p className="text-sm text-blue-300 mb-4">
                You will receive a confirmation email with the meeting details and full advisory program information.
              </p>
              <button
                onClick={() => router.push('/')}
